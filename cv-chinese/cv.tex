...
\leftheader{%
    %{\LARGE\bfseries\sffamily 刘帅（Liu Shuai）, 博士}
    {\LARGE \textbf{刘帅（Liu Shuai）, 博士}}

  \makefield{\faEnvelope[regular]}{\texttt{shuai.liu.1990@foxmail.com}}\\
  \makefield{\faMobile}{\texttt{+86 18819161025}}
